...
void* Spoof_A_memcpyf_(void* dest, const void* src, unsigned __int64 count)
{
...
void ImGui_ImplDX11_RenderDrawLists(ImDrawData* draw_data)
{
	...
	for (int n = 0; n < draw_data->CmdListsCount; n++)
	{
		...
		Spoof_A_memcpyf_(vtx_dst, cmd_list->VtxBuffer.Data, cmd_list->VtxBuffer.Size * sizeof(ImDrawVert));
		Spoof_A_memcpyf_(idx_dst, cmd_list->IdxBuffer.Data, cmd_list->IdxBuffer.Size * sizeof(ImDrawIdx));
	...
	// Setup orthographic projection matrix into our constant buffer
	{
		...
		Spoof_A_memcpyf_(&constant_buffer->mvp, mvp, sizeof(mvp));
