...
int STBTT_strlenf_(const char* string)
{
	int cnt = 0;
	if (string)
	{
...
#ifndef STBTT_strlen
#include <string.h>
#define STBTT_strlen(x)    STBTT_strlenf_(x)
#endif

void* STBTT_memcpyf_(void* dest, const void* src, unsigned __int64 count)
{
...
#ifndef STBTT_memcpy
#include <memory.h>
#define STBTT_memcpy       STBTT_memcpyf_
